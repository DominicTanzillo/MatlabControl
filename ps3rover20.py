...
"""KEY_LIGHTS      = pygame.K_KP6  # Square button toggles lights
KEY_STEALTH     = pygame.K_KP4  # Circle button toggles stealth mode
KEY_CAMERA_UP   = pygame.K_KP8  # Triangle button raises camera
KEY_CAMERA_DOWN = pygame.K_KP2  # X button lowers camera"""
...
class PS3Rover(Rover20):
    ...
    def __init__(self):
        ...
        # Use Keyboard
            ...
            self.treadstep = .05 # float value for rate of change
            self.changer = {
                -1: self.stop,
                119: self.w,
                97: self.a,
